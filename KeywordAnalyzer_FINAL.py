...
import glob
absFiles = glob.glob('*_abstractKeywords.csv')
absIndex = glob.glob('*_keywordsByAbstract.csv')
absYears = glob.glob('*_keywordYears.csv')
absTitle = glob.glob('*_Title.csv')
...
plt.savefig('AllChangingWords_2D.png')
plt.clf()
plt.close()
...
plt.ylabel('y-Intercept of Linear Model (%)', fontweight = 'bold', fontsize = 14)
plt.title('Words with Significant Trends', fontweight = 'bold')
plt.savefig('AllChangingWords_2D_zoom.png')
plt.clf()
plt.close()


# # plot some of the changing keywords
...
plt.savefig('DecreasingWords.png')
plt.clf()
plt.close()
...
plt.margins(0.2)
plt.savefig('DecreaseConnectedness.png')
plt.close()
...
plt.margins(0.2)
plt.savefig('IncreaseConnectedness.png')
plt.close()
